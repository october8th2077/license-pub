...
**Copyright (c) 2026 auto git cr. All rights reserved.**

## 1. Proprietary Notice
This software and its documentation are proprietary to auto git cr. This is not open-source software. The source code is confidential and not available to the public.

## 2. Grant of License
Subject to the terms of this Agreement, the Author hereby grants you a non-exclusive, non-transferable license to download, install, and use the plugin for personal or professional purposes within supported IntelliJ-based IDEs.

## 3. Restrictions
You agree NOT to:
* Decompile, disassemble, or reverse engineer the software.
* Modify, adapt, or create derivative works based on the software.
* Rent, lease, lend, sell, or redistribute the software (in whole or in part) to any third party.
